...
import static org.javaacademy.taxi.Time.DAY;
import static org.javaacademy.taxi.Time.NIGHT;
...
public class Runner {
	...
	public static void main(String[] args) {
		...
		company.acceptOrder(client1, DAY);
		company.acceptOrder(client2, DAY);
		company.acceptOrder(client3, NIGHT);
		company.acceptOrder(client4, NIGHT);
